# LeanSpectrum v0.1.0 — release notes template

To copy into the GitHub Release body once the binary builds are ready.
...
- The **macOS arm64** binary is the only smoke-tested Apple Silicon
  path; the **macos-13 Intel** build is included as a courtesy and
  should work but hasn't been validated on hardware.
