...
std::string GCode::_extrude(const ExtrusionPath& path, std::string description, double speed)
{
    ...
    // Orca: wave-overhang print speed override. Overrides any prior speed
    // selection (including dynamic overhang-speed results) so wave-overhang
    // paths print at the user-configured wave speed. Note our base computes
    // F = speed * 60 above, so we recompute it after overriding speed.
