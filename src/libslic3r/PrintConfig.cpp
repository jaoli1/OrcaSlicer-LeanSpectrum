...
// LeanSpectrum: wave-overhang enum maps. Ported from
// dennisklappe/OrcaSlicer-WaveOverhangs. The enums themselves live in
// PrintConfig.hpp; the maps below tie the string values used in the
// .ini / .json serialisation to the enum integers. See
// doc/leanspectrum/PORT_WAVE_OVERHANGS.md for the full port plan.
