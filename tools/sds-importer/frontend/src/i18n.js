...
const messages = {
  en: {
    ...
    filament_select_all: "Select all shown",
    ...
    reveal_folder:       "Open profiles folder",
    status_done:         "Done.",
  ...
  fr: {
    ...
    filament_select_all: "Tout sélectionner",
    ...
    reveal_folder:       "Ouvrir le dossier des profils",
    status_done:         "Terminé.",
