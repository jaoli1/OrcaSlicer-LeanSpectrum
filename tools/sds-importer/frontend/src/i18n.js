...
const messages = {
  en: {
    ...
    filament_intro:      "Search the filament database (built from manufacturers' own TDS / SDS sheets), pick a material, choose your printer above, then generate the filament profile AND its 7 process profiles in one click.",
    ...
    filament_pick_one:   "Select a filament in the list.",
    filament_result_for: "Generated for {printer}",
    filament_result_filament: "Filament profile",
    filament_result_process:  "process profiles",
    process_intro:       "Generate the 7 project-type process profiles for the printer selected above (or the full Snapmaker U1 set). Filament-specific tuning stays on the filament profile.",
    ...
    library_or_u1:       "— or generate the full Snapmaker U1 set (all 4 nozzles) —",
    library_generate:    "Generate the Snapmaker U1 set",
  ...
  fr: {
    ...
    filament_intro:      "Recherchez dans la base de filaments (construite depuis les fiches TDS / SDS officielles des fabricants), choisissez un matériau, sélectionnez votre imprimante ci-dessus, puis générez le profil filament ET ses 7 profils process en un clic.",
    ...
    filament_pick_one:   "Sélectionnez un filament dans la liste.",
    filament_result_for: "Généré pour {printer}",
    filament_result_filament: "Profil filament",
    filament_result_process:  "profils process",
    process_intro:       "Génère les 7 profils process par type de projet pour l'imprimante choisie ci-dessus (ou le jeu complet Snapmaker U1). Le réglage propre au filament reste sur le profil filament.",
    ...
    library_or_u1:       "— ou générer le jeu complet Snapmaker U1 (les 4 buses) —",
    library_generate:    "Générer le jeu Snapmaker U1",
